...
usage=pd.read_csv('/Users/renjie/Documents/DIGI_TCA_2021/data/results2/VM-Usage.csv')
pricesheet=pd.read_csv('/Users/renjie/Documents/DIGI_TCA_2021/data/results2/azure-retail-multi-price-2021-07-01.csv')
...
###Div
div_title1 = Div(text='Recommandation System', style={'font-size': '300%'}, width=600)
div_space = Div(text=' ',width = 675)

#把表單放入網頁的佈局
layout_plot =column(row([div_space, div_title1]), row(column([select, select2, select3], width=225, height=200), p))
...
past1 = pd.read_csv('/Users/renjie/Documents/DIGI_TCA_2021/data/results2/2021-07-27_past_plot.csv', index_col='DATE', parse_dates=['DATE'])[-13:]
past2 = pd.read_csv('//Users/renjie/Documents/DIGI_TCA_2021/data/results2/2021-08-03_past_plot.csv', index_col='DATE', parse_dates=['DATE'])[-20:]
past3 = pd.read_csv('/Users/renjie/Documents/DIGI_TCA_2021/data/results2/2021-08-10_past_plot.csv', index_col='DATE', parse_dates=['DATE'])[-27:]
past4 = pd.read_csv('/Users/renjie/Documents/DIGI_TCA_2021/data/results2/2021-08-17_past_plot.csv', index_col='DATE', parse_dates=['DATE'])[-34:]
past5 = pd.read_csv('/Users/renjie/Documents/DIGI_TCA_2021/data/results2/2021-08-24_past_plot.csv', index_col='DATE', parse_dates=['DATE'])[-41:]
past_ani = [past1, past2, past3, past4, past5]

forecast1_lstm = pd.read_csv('/Users/renjie/Documents/DIGI_TCA_2021/data/results2/2021-07-27_LSTM_forecast_plot.csv', index_col='DATE', parse_dates=['DATE'])
forecast2_lstm = pd.read_csv('/Users/renjie/Documents/DIGI_TCA_2021/data/results2/2021-08-03_LSTM_forecast_plot.csv', index_col='DATE', parse_dates=['DATE'])
forecast3_lstm = pd.read_csv('/Users/renjie/Documents/DIGI_TCA_2021/data/results2/2021-08-10_LSTM_forecast_plot.csv', index_col='DATE', parse_dates=['DATE'])
forecast4_lstm = pd.read_csv('/Users/renjie/Documents/DIGI_TCA_2021/data/results2/2021-08-17_LSTM_forecast_plot.csv', index_col='DATE', parse_dates=['DATE'])
forecast5_lstm = pd.read_csv('/Users/renjie/Documents/DIGI_TCA_2021/data/results2/2021-08-24_LSTM_forecast_plot.csv', index_col='DATE', parse_dates=['DATE'])
...
forecast1_prophet = pd.read_csv('/Users/renjie/Documents/DIGI_TCA_2021/data/results2/2021-07-27 forcast plot.csv', index_col='DATE', parse_dates=['DATE'])
forecast2_prophet = pd.read_csv('/Users/renjie/Documents/DIGI_TCA_2021/data/results2/2021-08-03 forcast plot.csv', index_col='DATE', parse_dates=['DATE'])
forecast3_prophet = pd.read_csv('/Users/renjie/Documents/DIGI_TCA_2021/data/results2/2021-08-10 forcast plot.csv', index_col='DATE', parse_dates=['DATE'])
forecast4_prophet = pd.read_csv('/Users/renjie/Documents/DIGI_TCA_2021/data/results2/2021-08-17 forcast plot.csv', index_col='DATE', parse_dates=['DATE'])
forecast5_prophet = pd.read_csv('/Users/renjie/Documents/DIGI_TCA_2021/data/results2/2021-08-24 forcast plot.csv', index_col='DATE', parse_dates=['DATE'])
...
p1_lstm_ani = figure(x_axis_type='datetime', y_range=(100, 180), x_axis_label='Date', y_axis_label='Consumed Quantity', plot_width=600, plot_height=400, tools='')
...
p1_lstm_ani.title.text_font_size = '20px'
p1_lstm_ani.xaxis.axis_label_text_font_size = '14pt'
p1_lstm_ani.xaxis.major_label_text_font_size = '12pt'
...
p1_prophet_ani = figure(x_axis_type='datetime', y_range=(100, 180), x_axis_label='Date', y_axis_label='Consumed Quantity', plot_width=600, plot_height=400, tools='')
...
p1_prophet_ani.title.text_font_size = '20px'
p1_prophet_ani.xaxis.axis_label_text_font_size = '14pt'
p1_prophet_ani.xaxis.major_label_text_font_size = '12pt'
...
past = pd.read_csv('/Users/renjie/Documents/DIGI_TCA_2021/data/results2/2021-08-24_past_plot.csv', index_col='DATE', parse_dates=['DATE'])[-23:]
forecast_lstm = pd.read_csv('/Users/renjie/Documents/DIGI_TCA_2021/data/results2/2021-08-24_LSTM_forecast_plot.csv', index_col='DATE', parse_dates=['DATE'])
recom_lstm = pd.read_csv('/Users/renjie/Documents/DIGI_TCA_2021/data/results2/2021-08-24_LSTM_recommendation.csv', index_col=0)
forecast_prophet = pd.read_csv('/Users/renjie/Documents/DIGI_TCA_2021/data/results2/2021-08-24_Prophet_forecast_plot.csv', index_col='DATE', parse_dates=['DATE'])
recom_prophet = pd.read_csv('/Users/renjie/Documents/DIGI_TCA_2021/data/results2/2021-08-24_Prophet_recommendation.csv')
...
p1_lstm = figure(x_axis_type='datetime', y_range=(100, 180), x_axis_label='Date', y_axis_label='Consumed Quantity', plot_width=850, plot_height=400, tools='')
p1_lstm.xaxis.axis_label_text_font_style = 'normal'
p1_lstm.yaxis.axis_label_text_font_style = 'normal'
p1_lstm.title.text = 'Forecast of Consumed Quantity in one Week & Reserved Instance Coverage'
p1_lstm.title.text_font_size = '20px'
...
p1_prophet = figure(x_axis_type='datetime', y_range=(100, 180), x_axis_label='Date', y_axis_label='Consumed Quantity', plot_width=850, plot_height=400, tools='')
p1_prophet.xaxis.axis_label_text_font_style = 'normal'
p1_prophet.yaxis.axis_label_text_font_style = 'normal'
p1_prophet.title.text = 'Forecast of Consumed Quantity in one Week & Reverse Instance Coverage'
p1_prophet.title.text_font_size = '20px'
...
p2_lstm.title.text_font_size = '20px'
...
p2_prophet.title.text_font_size = '20px'
...
div4 = Div(text='', width=525)

div_pricing = Div(text='Pricing:<br> Enterprise Agreement: $0.13 / hour<br> Reserved Instance (1 year): $52.92 / month<br> Reserved Instance (3 year): $33.61 / month', style={'font-size': '150%'}, width=300)

div3_lstm = Div(text='''Enterprise Agreement Price: ${} / month.<br>
...
div3_prophet = Div(text='''Enterprise Agreement Price: ${} / month.<br>
...
def update_vbar(attr, old, new):
    if radio_button_group.active == 0: 
        ...
        'RI' : [recom_prophet.iloc[0,1], recom_prophet.iloc[1,1], recom_prophet.iloc[2,1]],
        'chr' : [str(int(recom_prophet.iloc[0,1])), str(int(recom_prophet.iloc[1,1])), str(int(recom_prophet.iloc[2,1]))]}
        div3_lstm.text = '''Enterprise Agreement Price: ${} / month.<br>
You can save at most ${} / month by buying {} (1 year).<br><br>* Recommendation of the two models are the same.'''.format(int(recom_lstm.iloc[0,3]), int(recom_lstm.iloc[0,3]-min(source_recom_lstm.data['RI'])), source_recom_lstm.data['label'][np.argmin(source_recom_lstm.data['RI'])])
        div3_prophet.text = '''Enterprise Agreement Price: ${} / month.<br>
...
tab1 = Panel(child=layout([[div4, p1_lstm_ani], [radio_button_group], [p1_lstm, div1, p2_lstm], [divh], [div2, div_pricing, div3, div3_lstm]]), title='AI Model')
tab2 = Panel(child=layout([[div4, p1_prophet_ani], [radio_button_group], [p1_prophet, div1, p2_prophet], [divh], [div2, div_pricing, div3, div3_prophet]]), title='Statistics Model')
